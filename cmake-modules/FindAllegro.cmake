...
if (PKGCONFIG_FOUND)
  ...
  foreach (VERSION_STR_IT ${VERSION_STRS})
    string(REGEX MATCH "[0-9].[0-9]" VERSION_STR_IT_OUT "${VERSION_STR_IT}")
      # If there is only one version number
      if(VERSION_STR_IT_OUT STREQUAL "")
        string(REGEX MATCH "[0-9]" VERSION_STR_IT "${VERSION_STR_IT}")
        else()
         set(VERSION_STR_IT ${VERSION_STR_IT_OUT})
        endif()
...
#-------------------------------------------------------
if("${allegro_INCLUDE_DIRS}" STREQUAL "")
else()
  list(REMOVE_DUPLICATES allegro_INCLUDE_DIRS)
endif()
if(allegro_LIBRARIES STREQUAL "")
else()
  list(REMOVE_DUPLICATES allegro_LIBRARIES)
endif()
if("${allegro_LIBRARY_DIRS}" STREQUAL "")
  else()
